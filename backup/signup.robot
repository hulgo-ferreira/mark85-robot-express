...
#cenário que utiliza a ténica de Template, chamando uma única keyword e fazer reaproveitamente de código
    [Tags]    short_pass
    [Template]
    Short password    1
...
# Este é um template de teste que valida a senha com poucos caracteres e que está sendo usado em todos os testes desse arquivo.
*** Keywords ***
Short password
